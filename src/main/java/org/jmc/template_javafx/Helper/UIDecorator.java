...
//        button.setMnemonicParsing(true);
    ...
    public static FontIcon ITEM() {
        return new FontIcon(Feather.COFFEE);
    }

    public static FontIcon SHIPPER() {
        return new FontIcon(Material2AL.ELECTRIC_MOPED);
    }

    public static FontIcon ORDER() {
        return new FontIcon(Feather.SHOPPING_CART);
    }
}
